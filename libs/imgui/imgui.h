...
namespace ImGui
{
    ...
    IMGUI_API const char*   GetKeyName(ImGuiKey key);                                           // [BYPASS] returns English name of the key. Those names are provided for debugging purpose and are not meant to be saved persistently nor compared.
